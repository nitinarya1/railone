    ...
    (
      <div
        style={{
          width: '100%',
          height: '100%',
          background: '#0A64F8', /* Match the exact blue of RailOne */
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          borderRadius: '20%', /* App icon squircle */
        }}
      >
        <svg width="300" height="200" viewBox="0 0 300 200" fill="none" style={{ marginLeft: '10px' }}>
